Write code to render an image of a ball with shadow into a text file of NxM characters with ASCII art. 
...
No colours are needed, but shades of grey shall be imitated with ASCII characters.
